...
export default function Blog_1() {
 ...
 {/* grid blog_1  */}
  <div id="blogify">
    <h1 class="text-danger ml-5 mt-5">Oral Cancer: Importance of Staging in Diagnosis and Treatment</h1>
    ...
    <div id="blogify-text">
      ...
      <h2 class="mt-5 text-danger">The Stages of Oral Cancer</h2>

      {/* stage 0  */}
      <p class="stages p-2"><span class="ml-3">Stage 0: Carcinoma in Situ – The Precancerous Phase :</span></p>
      ...
      <p>Various treatment modalities, such as surgery, laser therapy, or topical medications, may be employed to
       ...
       {/* stage 1 */}
      <p class="stages p-2"><span class="ml-3">Stage I Oral Cancer: Early Diagnosis:</span></p>
      ...
      <p>Treatment options may include surgical excision of the tumor, radiation therapy, or a combination of both, to
       ...
       {/* stage 2  */}
      <p class="stages p-2"><span class="ml-3">Stage II Oral Cancer: Locally Advanced Tumors:</span></p>
      ...
      <p>Treatment approaches become more complex, often requiring a multidisciplinary approach involving surgical
       ...
       {/* stage 3 */}
      <p class="stages p-2"><span class="ml-3">Stage III Oral Cancer: Regional Lymph Node Involvement:</span></p>
      ...
      <h2 class="mt-5 text-danger">The Impact of Staging on Treatment Options</h2>
      ...
      <h2 class="mt-5 text-danger">Advancements in Oral Cancer Treatment</h2>
      ...
      <ul type="square" id="oral-list">
        <li><span class="text-info">Immunotherapy:</span> This cutting-edge treatment modality harnesses the power of
        ...
        <li><span class="text-info">Targeted Therapies:</span> Targeted therapies are designed to specifically target
        ...
        <li>
          <span class="text-info">Precision Medicine:</span> The advent of genomic sequencing technologies has
        ...
        <li><span class="text-info">Minimally Invasive Surgery:</span> Advances in surgical techniques have led to less
        ...
        <li>
          <span class="text-info">Supportive Care and Rehabilitation:</span> Managing the physical, emotional, and
      ...
      <h2 class="mt-5 text-danger">Conclusion</h2>
